...
%{\bf University of Oregon}, graduate student (doctoral candidate)
...
Computational molecular simulation techniques (ab initio DFT, classical).

Programming: C++, STL, Boost, C, Python, Haskell, MPI, Template meta-programming, Functional programming, Object-oriented programming, Distributed computing.

UNIX cluster system administration.
